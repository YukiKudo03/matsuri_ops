defmodule MatsuriOpsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MatsuriOpsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MatsuriOpsWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def back(assigns) do
    ~H"""
    <div class="mt-8">
      <.link navigate={@navigate} class="text-sm font-semibold leading-6 hover:underline">
